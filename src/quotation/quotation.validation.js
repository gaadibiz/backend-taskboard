...
exports.upsertQuotationSchema = Joi.object({
  quotation_uuid: Joi.string().guid().max(100).allow('', null),
  quotation_no: Joi.string().allow(''),
  quotation_date: Joi.string().required(),
  challan_no: Joi.string().allow(null, ''),
  challan_date: Joi.string().isoDate().allow(null, ''),
  quotation_type: Joi.string().max(255).allow('', null),
...
exports.getQuotationSchema = Joi.object({
  combined_quotation_no: Joi.string(),
  quotation_uuid: Joi.string().guid(),
