...
exports.upsertUserProfileSchema = Joi.object({
  ...
  is_physically_handicapped: Joi.number().allow(null),
  ...
  lwf_eligible: Joi.number().allow(null),
  ...
  pan_card_available: Joi.number().allow(null),
